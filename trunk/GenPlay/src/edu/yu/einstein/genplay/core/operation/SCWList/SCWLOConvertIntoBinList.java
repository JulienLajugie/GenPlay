 ...
 * interface into a {@link BinList}.
 * @author Julien Lajugie
 */
public class SCWLOConvertIntoBinList implements Operation<BinList> {
	...
	/**
	 * Creates an instance of {@link SCWLOConvertIntoBinList}
	 * @param inputList list to convert
	 * @param binSize size of the bins of the result {@link BinList}
	 * @param scoreOperation score operation to compute the scores of the bins
	 */
	public SCWLOConvertIntoBinList(GenomicListView<? extends ScoredChromosomeWindow> inputList, int binSize, ScoreOperation scoreOperation) {
	...
	public BinList compute() throws Exception {
		...
		BinListPileupFlattener flattener = new BinListPileupFlattener(binSize, scoreOperation);
		...
		return (BinList) gwFlattener.getSCWList();
	}


	@Override
	public String getDescription() {
		return "Operation: Convert Into Bin List";
	}
