 ...
 ******************************************************************************/
package edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.managers;
...
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.EditingDialog;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.EditingPanel;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.FilterValuesPanel;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.editing.MultiGenomeEditingPanel;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.editing.OperatorEditingPanel;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.selection.FileSelectionPanel;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.selection.IDFilterSelectionPanel;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterDialog.dialog.panels.selection.LayerSelectionPanel;
 ...
 */
public class AddOrEditVariantFiltersDialog {
	...
	public List<FiltersData> showDialog() {
		initializePanels();
		EditingDialog editingDialog = new EditingDialog(this);
