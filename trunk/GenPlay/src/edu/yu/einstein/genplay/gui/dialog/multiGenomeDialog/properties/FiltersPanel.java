...
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.filterTable.TableHeaderPanel;
...
public class FiltersPanel extends JPanel implements ActionListener, MouseListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (button.equals(jbAddRows)) {
			List<FiltersData> tableData = editingDialogManager.showDialog();
			if (tableData != null) {
