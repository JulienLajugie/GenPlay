 ...
 * @param <T> type of the data returned by the scaling method
 * @author Julien Lajugie
 */
public interface DataScalerForTrackDisplay<T> extends Serializable {

	/**
	 * @return the data rescaled to be displayed in the track for the {@link ProjectWindow}
	 */
	public T getDataScaledForTrackDisplay();
}
