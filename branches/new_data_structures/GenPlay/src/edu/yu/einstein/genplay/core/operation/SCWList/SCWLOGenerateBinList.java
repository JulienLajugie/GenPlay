...
/**
 * Creates a BinList from the data of the input {@link SCWList}
...
public class SCWLOGenerateBinList implements Operation<BinList> {
	 ...
	 */
	public SCWLOGenerateBinList(SCWList scwList, int binSize, ScorePrecision precision, ScoreOperation method) {
