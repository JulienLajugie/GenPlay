...
import edu.yu.einstein.genplay.core.operation.SCWList.SCWLOMin;
...
/**
 * Shows the minimum score of the selected {@link AbstractSCWLayer}
...
public final class SCWLAMin extends TrackListActionOperationWorker<Float> {
	...
	private AbstractSCWLayer<?>		selectedLayer;						// selected layer


	/**
	 * key of the action in the {@link ActionMap}
	 */
	public static final String ACTION_KEY = SCWLAMin.class.getName();
	...
	public Operation<Float> initializeOperation() {
		selectedLayer = (AbstractSCWLayer<?>) getValue("Layer");
