 ...
 */
public class GenericSCWLayer extends AbstractVersionedLayer<SCWList> implements Layer<SCWList>, VersionedLayer<SCWList>, GraphLayer, ColoredLayer, SCWLayer {
	...
	/**
	 * Creates an instance of a {@link GenericSCWLayer}
	 * @param track track containing the layer
	 * @param data data of the layer
	 * @param name name of the layer
	 */
	public GenericSCWLayer(Track track, SCWList data, String name) {
