...
/**
 * Subtracts a specified constant from the scores of each window of a {@link SimpleScoredChromosomeWindow}
 * @author Julien Lajugie
 */
public class SCWLOSubtractConstant implements Operation<SCWList> {

	private final SCWList 	scwList;			// input list
	private final float 	constant;			// constant to subtract
	private boolean			stopped = false;	// true if the operation must be stopped


	/**
	 * Subtracts a specified constant to the scores of each window of a {@link SimpleScoredChromosomeWindow}
	 * @param scwList input list
	 * @param constant constant to subtract
	 */
	public SCWLOSubtractConstant(SCWList scwList, float constant) {
