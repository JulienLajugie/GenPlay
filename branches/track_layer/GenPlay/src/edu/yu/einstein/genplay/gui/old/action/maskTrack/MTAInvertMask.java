 ...
 * @version 0.1
 */
public final class MTAInvertMask extends TrackListActionOperationWorker<ScoredChromosomeWindowList> {
	...
	/**
	 * Creates an instance of {@link MTAInvertMask}
	 */
	public MTAInvertMask() {
		super();
