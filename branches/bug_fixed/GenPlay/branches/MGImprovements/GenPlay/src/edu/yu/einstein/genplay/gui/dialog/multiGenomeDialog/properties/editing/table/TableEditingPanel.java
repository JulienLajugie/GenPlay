...
public class TableEditingPanel<K> extends JPanel implements ActionListener, MouseListener {
	...
	private final 	EditingTable<K> 	table;			// the table that summarize all stripes/filters settings
	private final 	EditingDialogManagerInterface<K> editingDialogManager;
