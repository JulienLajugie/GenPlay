 ...
 */
public class GenomicListOfGenesScaler implements DataScalerForTrackDisplay<List<List<Gene>>> {
	...
	private final GenomicDataList<Gene>	dataToScale;		// data to be scaled for track display
	 ...
	 */
	public GenomicListOfGenesScaler(GenomicDataList<Gene> geneList, FontMetrics fontMetrics) {
