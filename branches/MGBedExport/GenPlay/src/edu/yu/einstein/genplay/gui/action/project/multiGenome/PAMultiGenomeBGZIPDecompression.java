 ...
 * @version 0.1
 */
public class PAMultiGenomeBGZIPDecompression extends TrackListActionWorker<Void> {
	...
	/**
	 * Creates an instance of {@link PAMultiGenomeBGZIPDecompression}.
	 * @param file the file to compress
	 */
	public PAMultiGenomeBGZIPDecompression(File file) {
		super();
