 ...
 * @version 0.1
 */
public class NoCallVariantOld implements Serializable, Variant {
	...
	/**
	 * Constructor of {@link NoCallVariantOld}
	 * @param referenceGenomePosition
	 * @param chromosomeCode code of the chromosome (eg: 1 -> chr1)
	 * @param file the associated vcf file
	 */
	public NoCallVariantOld(int referenceGenomePosition, int chromosomeCode, VCFFile file) {
	...
	public boolean equals(Object obj) {
		...
		NoCallVariantOld test = (NoCallVariantOld)obj;
