 ...
 * @version 0.1
 */
public class FileEditingPanel extends EditingPanel<VCFFile> implements ListSelectionListener {
	...
	/**
	 * Constructor of {@link FileEditingPanel}
	 */
	public FileEditingPanel() {
		super("File");
	}
