...
abstract public class EditingPanel<K> extends JPanel {
	...
	private 	JLabel 					titleLabel;					// The label for the title
	private		JScrollPane 			scrollPane;					// The scroll pane that contains the content pane
	private 	List<EditingPanel<?>> 	editingPanelListeners;		// Editing panels listening the current panel (can be null)
	...
	private void setSize (Component comp, Dimension dim) {
		comp.setSize(dim);
