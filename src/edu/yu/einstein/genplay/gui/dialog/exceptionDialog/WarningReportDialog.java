...
public class WarningReportDialog extends JDialog {
	 ...
	 */
	public static WarningReportDialog getInstance() {
		if (instance == null) {
			synchronized(WarningReportDialog.class) {
				if (instance == null) {
					instance = new WarningReportDialog();
				}
			}
		}
		return instance;
	...
	/**
	 * Constructor of {@link WarningReportDialog}
	 */
	private WarningReportDialog () {
		// Dialog layout
