...
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.editing.editors.IDEditor;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.editing.editors.IDFlagEditor;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.editing.editors.IDGTEditor;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.editing.editors.IDNumberEditor;
import edu.yu.einstein.genplay.gui.dialog.multiGenomeDialog.properties.editing.editors.IDStringEditor;

/**
 * @author Nicolas Fourel
 * @version 0.1
 */
public class FilterEditingPanel extends EditingPanel<IDFilterInterface> implements ActionListener {
	 ...
	 */
	public IDFilterInterface getIDFilter () {
	...
	@Override
	public void initialize(IDFilterInterface element) {
		if (filterEditor != null) {
			if (element instanceof GenotypeIDFilter) {
				specialFilterEditor.initializesPanel(element);
				enableSpecialPanel();
			} else {
