...
/**
 * Divides the scores of the selected {@link BinLayer} by a constant
...
public class BLADivideConstant extends TrackListActionOperationWorker<BinList> {
	...
	public Operation<BinList> initializeOperation() {
		...
		if (selectedLayer != null) {
			Number constant = NumberOptionPane.getValue(getRootPane(), "Constant", "Divide the scores of the layer by", new DecimalFormat("0.0"), Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 0);
