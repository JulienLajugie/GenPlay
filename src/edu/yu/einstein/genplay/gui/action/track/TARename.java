 ...
 * @version 0.1
 */
public final class TARename extends TrackListAction {

	private static final long serialVersionUID = -194860924510577098L;		// generated serial ID
	 ...
	 */
	public static final String ACTION_KEY = "TARename";


	/**
	 * Creates an instance of {@link TARename}
	 */
	public TARename() {
		super();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (selectedTrack != null) {
			String message = "Enter a name for the track #" + selectedTrack.getNumber() + ":";
