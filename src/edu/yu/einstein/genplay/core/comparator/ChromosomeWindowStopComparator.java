...
public class ChromosomeWindowStopComparator implements Comparator<ChromosomeWindow>{
	...
	/**
	 * @return -1 if the stop position of the first specified {@link GenomeWindow} is smaller than the stop position of the second one <br>
	 * 0 if the stop positions are equals <br>
	 * 1 the stop position of the first specified {@link GenomeWindow} is greater than the stop position of the second one
	 */
	@Override
