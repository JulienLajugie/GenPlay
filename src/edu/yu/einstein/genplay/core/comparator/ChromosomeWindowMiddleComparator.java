...
public class ChromosomeWindowMiddleComparator implements Comparator<ChromosomeWindow>{
	...
	/**
	 * @return -1 if the middle position of the first specified {@link GenomeWindow} is smaller than the middle position of the second one <br>
	 * 0 if the middle positions are equals <br>
	 * 1 the middle position of the first specified {@link GenomeWindow} is greater than the middle position of the second one
	 */
	@Override
