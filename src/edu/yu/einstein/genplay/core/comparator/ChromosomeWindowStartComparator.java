...
/**
 * Comparator between the start position of 2 {@link ChromosomeWindow}.
...
public class ChromosomeWindowStartComparator implements Comparator<ChromosomeWindow>{
	 ...
	 * 0 if the start positions are equal <br>
	...
	public int compare(ChromosomeWindow chromosomeWindow1, ChromosomeWindow chromosomeWindow2) {
		if (chromosomeWindow1.getStart() < chromosomeWindow2.getStart()) {
			return -1;
		} else if (chromosomeWindow1.getStart() == chromosomeWindow2.getStart()) {
			return 0;
		} else {
			return 1;
		}
