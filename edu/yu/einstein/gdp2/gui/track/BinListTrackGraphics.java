...
public final class BinListTrackGraphics extends CurveTrackGraphics implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	private URRManager<BinList> urrManager; 	// manager that handles the undo / redo / reset of the track
	...
	protected BinListTrackGraphics(GenomeWindow displayedGenomeWindow, BinList binList) {
		...
		urrManager = new URRManager<BinList>(ConfigurationManager.getInstance().getUndoCount(), binList);
	}
	...
	/**
	 * Resets the BinList. 
	 * Copies the value of the original BinList into the current value
	 */
