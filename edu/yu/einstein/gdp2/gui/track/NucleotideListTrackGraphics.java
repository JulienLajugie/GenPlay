...
public class NucleotideListTrackGraphics extends TrackGraphics {
	...
	private static final Color THYMINE_COLOR = new Color(22, 174, 0);				// color for thymine bases
	private static final Color CYTOSINE_COLOR = Color.red;							// color for cytosine bases
	private static final Color ADENINE_COLOR = Color.blue;							// color for adenine bases
	private static final Color GUANINE_COLOR = Color.magenta;						// color for guanine bases
