...
public final class IndexationPerChromosomeAction extends TrackListAction {
	 ...
	 */
	public IndexationPerChromosomeAction() {
		super();
			...
			if (selectedTrack.getBinList().getPrecision() == DataPrecision.PRECISION_1BIT) {
				...
				if (indexMin != null) {
					...
					if(indexMax != null) {
						...
						final BinListOperation<BinList> operation = new BLOIndexByChromosome(binList, indexMin.doubleValue(), indexMax.doubleValue());
