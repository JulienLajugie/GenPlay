...
import yu.einstein.gdp2.core.SNPList.operation.SLOFindPrevious;
 ...
 * @version 0.1
 */
public class SLAFindPrevious extends TrackListActionOperationWorker<SNP> {
	 ...
	 */
	public static final String ACTION_KEY = "SLAFindPrevious";


	/**
	 * Creates an instance of {@link SLAFindPrevious}
	 */
	public SLAFindPrevious() {
		super();
	...
	public Operation<SNP> initializeOperation() throws Exception {
		...
		if ((selectedTrack != null) && (selectedTrack.getData() instanceof SNPList)) {
			...
			Operation<SNP> operation = new SLOFindPrevious(inputList, currentWindow.getChromosome(), (int) currentWindow.getMiddlePosition());
			return operation;
		}
		return null;
	}
