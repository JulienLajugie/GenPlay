...
/**
 * Panel of the {@link OptionDialog} that allows to 
 * <br/> - choose the default directory
 * <br/> - choose the log file
 * <br/> - choose the look and feel
 * @author Julien Lajugie
 * @version 0.1
 */
public final class GeneralOptionPanel extends OptionPanel {
	 ...
	 */
	public GeneralOptionPanel(ConfigurationManager configMmanager) {
		super("General", configMmanager);
