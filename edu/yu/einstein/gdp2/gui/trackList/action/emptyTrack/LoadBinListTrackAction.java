...
import yu.einstein.gdp2.gui.trackList.worker.extractorWorker.BinListExtractorWorker;
...
public final class LoadBinListTrackAction extends TrackListAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		File selectedFile = Utils.chooseFileToLoad(getRootPane(), "Load Fixed Window Track", defaultDirectory);
