...
//			int i = 0;
//			for (i = 0; i < list.getData().length; ) {
//				if (list.getData() != null) {
//					libraryLength_s += list.getData()[i].length * getWindowWidth();
//					for (int j = 0; j < list.getData()[i].length; j++) {
//						totalReads_s += list.getData()[i][j];
//					}
//				}
//			}
...
//		double[] ret = new double[stats.getList().getData()[chromosome].length];
//
//		// If something goes wrong here, then something is seriously improperly
//		// written.
//		// This exception has no business being thrown here.
//		try {
//			for (int i = 0; i < stats.getList().getData()[chromosome].length; i++) {
...
//		int numReads = (int) stats.getList().getData()[chromosome][window];
//
