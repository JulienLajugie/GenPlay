...
public class Poisson {
	...
	/**
	 * Creates an instance of {@link Poisson} with parameter lambda. L values are calculated 
	 * until the resulting probability shrinks below the static thresholdProb variable. 
	 * @param lambda the lambda value to assign. 
	 */
	public Poisson (double lambda) throws PoissonInvalidParameterException {
	...
	public static void test(int depth) {
		...
		try {
			...
			for (int l = 0; l <= depth; l++) {
				...
				double Qcur = Poisson.evaulateQuickly(l, lambda);
				Qtotal += Qcur;
