...
/**
 * Class to Reposition and Rescore the exons
 * @author Chirag Gorasia
 * @version 0.1
 */
public class GeneRelativeToGenomePosition {
	 ...
	 */
	public GeneRelativeToGenomePosition(File coverageFile, File annotationFile, File repositionedFile, File gdpFile) {
	...
	public static void main (String args[]) {
		GeneRelativeToGenomePosition gr = new GeneRelativeToGenomePosition(new File(args[0]), new File(args[1]), new File(args[2]), new File(args[3]));
		gr.rePosition();		
	}
}