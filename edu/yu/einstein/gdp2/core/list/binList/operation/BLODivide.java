...
/**
 * Divides the scores of the bins of two specified BinLists
 * @author Julien Lajugie
 * @version 0.1
 */
public class BLODivide implements BinListOperation<BinList> {

	private final BinList 		binList1;	// first binlist 
	private final BinList 		binList2; 	// second binlist, the result is binlist1 / binlist2 
	private final DataPrecision precision;	// precision of the result list


	/**
	 * Divides the scores of the bins of the two specified BinLists: binList1 / binList2
	 * @param binList1
	 * @param binList2
	 * @param precision precision of the result {@link BinList} 
	 */
	public BLODivide(BinList binList1, BinList binList2, DataPrecision precision) {
