...
/**
 * Multiplies the scores of the bins of two specified BinLists
 * @author Julien Lajugie
 * @version 0.1
 */
public class BLOMultiply implements BinListOperation<BinList> {

	private final BinList 		binList1;	// first binlist to multiply 
	private final BinList 		binList2; 	// second binlist to multiply
	private final DataPrecision precision;	// precision of the result list


	/**
	 * Multiplies the scores of the bins of the two specified BinLists: binList1 * binList2
	 * @param binList1
	 * @param binList2
	 * @param precision precision of the result {@link BinList} 
	 */
	public BLOMultiply(BinList binList1, BinList binList2, DataPrecision precision) {
					...
					if ((currentList1 == null) || (currentList1.size() == 0) || (currentList2 == null) || (currentList2.size() == 0)) {
						...
						for (int j = 0; j < currentList1.size(); j++) {
							if(j < currentList2.size()) {
								// we multiply the bins of the two binlists
